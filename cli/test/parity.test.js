...
test("public CLI reads match existing browser tools, including complete cursor pages", async t => {
  ...
  const cases = [
    ...
    {tool: "search_threads", input: {origin: "shop.example", tool_name: "add_to_cart"}, args: ["reports", "search", "--origin", "shop.example", "--tool-name", "add_to_cart"], field: "results", body: {tools: [], reports: [], priority_reports: []}},
