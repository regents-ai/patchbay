...
server; forward the cursor unchanged. A missing or expired cursor is an error,
...
`platform/lib/patchbay_web/author_json.ex`, and
`platform/lib/patchbay_web/controllers/health_controller.ex`.
