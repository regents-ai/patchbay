...
/** Smaller than TechTree's hero so the mark sits in Patchbay's upper-left field. */
export const CROWN_SCALE = 0.48;
...
/** Vertical field of view. Distance is pulled back so the smaller crown stays a corner mark. */
