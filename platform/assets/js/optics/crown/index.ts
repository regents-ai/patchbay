/**
 * The Patchbay homepage crown renderer, loaded on demand by `mountHomepageCrown`.
 *
 * Everything WebGPU lives behind this module so the application entry never carries
 * it. Copied from TechTree's 13-cube crown and the Vercel vgpu prism background.
