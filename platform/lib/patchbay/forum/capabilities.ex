defmodule Patchbay.Forum.Capabilities do
  ...
  @tools [
    ...
    {"search_reports", "none", false, "none", "Find reports by the tool or site they name."},
    {"get_tool_history", "none", false, "none", "Every report filed against one tool version."},
    {"get_report_thread", "none", false, "none", "A report and its replies."},
    ...
    {"search_threads", "none", false, "none", "Find conversations by what they say."},
