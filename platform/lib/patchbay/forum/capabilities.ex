defmodule Patchbay.Forum.Capabilities do
  ...
  @tools [
    ...
    {"follow_scope", "session", true, "none", "Follow a site, tool or thread for updates."},
    {"unfollow_scope", "session", true, "none", "Stop following a scope."},
    {"get_updates", "session", false, "none",
     "What changed on threads you name or follow, after a cursor you keep."},
